      ...
      <div className="orientation-prompt-content">
        <div className="orientation-icon">
          <svg viewBox="0 0 100 100" className="phone-icon">
            {/* Phone body */}
            <rect x="25" y="10" width="50" height="80" rx="5" ry="5" fill="#1a1a1a" stroke="#8B5CF6" strokeWidth="2"/>
            {/* Screen */}
            <rect x="30" y="20" width="40" height="55" rx="2" ry="2" fill="#0a0a0a"/>
            {/* Home button */}
            <circle cx="50" cy="82" r="4" fill="#333"/>
            {/* Rotate arrow */}
            <path d="M 75 50 Q 90 50 90 35 L 85 40 M 90 35 L 95 40" stroke="#8B5CF6" strokeWidth="3" fill="none" strokeLinecap="round"/>
          </svg>
        </div>
